...
- [UserCache](classes/UserCache.md)
...
- [assertInstance](functions/assertInstance.md)
- [assertType](functions/assertType.md)
- [isAnyJIDEqual](functions/isAnyJIDEqual.md)
- [parseJIDs](functions/parseJIDs.md)
- [resolveLID](functions/resolveLID.md)
- [resolveLIDAndPN](functions/resolveLIDAndPN.md)
- [resolveLIDOrPN](functions/resolveLIDOrPN.md)
- [resolvePN](functions/resolvePN.md)
